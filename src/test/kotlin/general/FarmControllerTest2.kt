...
class FarmControllerTest2 {
    ...
    fun testFarmControllerFarmActions() {
        ...
        val c2 = data.getMap().getTileByID(2)?.getGrowable()?.getWasMowedAtTick()
        val c3 = data.getMap().getTileByID(3)?.getGrowable()?.getWasMowedAtTick()
        assert(c2 == 11)
        assert(c2 == c3)

        data.setCurrentTick(22)
        data.setYearTick(22)
        farmController.farmsAction()
        val w0 = data.getMap().getTileByID(0)?.getGrowable()?.getWasWeededAtTick()?.first()
        val w1 = data.getMap().getTileByID(1)?.getGrowable()?.getWasWeededAtTick()?.first()
        assert(w1 == 22)
        assert(w0 == w1)

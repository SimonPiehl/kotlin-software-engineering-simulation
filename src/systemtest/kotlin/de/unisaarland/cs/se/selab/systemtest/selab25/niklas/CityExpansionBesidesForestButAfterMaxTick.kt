 ...
 * @constructor
 */
class CityExpansionBesidesForestButAfterMaxTick : ExampleSystemTestExtension() {
    override val name = "CityExpansionBesidesForestButAfterMaxTick Niklas"
    override val description = "Scenario should be invalid. City expansion is besides FOREST, it happens after maxTick."

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "example/farms.json"
    override val scenario = "niklas/scenarioCityExpansionBesidesForestButAfterMaxTick.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine(
            "[IMPORTANT] Initialization Info: scenarioCityExpansionBesidesForestButAfterMaxTick.json is invalid."
        )
    }
}

 ...
 */
class StatisticTest10 : ExampleSystemTestExtension() {
    override val name = "StatisticTest10"
    ...
    override suspend fun run() {
        skipUntilString("[IMPORTANT] Simulation Statistics: Total amount of POTATO harvested:")
        assertCurrentLine("[IMPORTANT] Simulation Statistics: Total amount of POTATO harvested: 348677 g.")
    }
}

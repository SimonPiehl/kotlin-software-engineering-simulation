...
/**
 * Cloud merge creation nine
 *
 * @constructor Create empty Cloud merge creation nine
 */
class CloudMergeCreationNine : ExampleSystemTestExtension() {
    override val name = "CloudMergeDurationNine Simon"
    ...
    override suspend fun run() {
        ...
        skipUntilCloudUnion()
        assertNextLine(
            "[IMPORTANT] Cloud Union: Clouds 0 and 1 united to cloud 2 with 6400 L water and duration 9 on tile 1."
        )
    }

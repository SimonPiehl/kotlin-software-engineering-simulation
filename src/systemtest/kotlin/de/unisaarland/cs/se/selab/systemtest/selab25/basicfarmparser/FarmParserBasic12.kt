 ...
 */
class FarmParserBasic12 : ExampleSystemTestExtension() {
    override val name = "sowown2"
    override val description = "sowown2.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/sowown2.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: sowown2.json is invalid.")
    }
}

 ...
 */
class FarmParserBasic21 : ExampleSystemTestExtension() {
    override val name = "hasaction should work"
    override val description = "hasaction.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/t/hasaction.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[INFO] Initialization Info: hasaction.json successfully parsed and validated.")
    }
}

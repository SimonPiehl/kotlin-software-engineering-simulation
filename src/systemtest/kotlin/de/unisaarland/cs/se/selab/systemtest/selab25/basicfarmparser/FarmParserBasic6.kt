 ...
 */
class FarmParserBasic6 : ExampleSystemTestExtension() {
    override val name = "hasallfields3"
    override val description = "hasallfields3.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/hasallfields3.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: hasallfields3.json is invalid.")
    }
}

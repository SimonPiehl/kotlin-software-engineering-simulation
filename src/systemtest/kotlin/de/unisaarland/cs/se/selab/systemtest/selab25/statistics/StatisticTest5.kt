 ...
 */
class StatisticTest5 : ExampleSystemTestExtension() {
    override val name = "StatisticTest5"
    ...
    override suspend fun run() {
        skipUntilString("[IMPORTANT] Simulation Statistics: Total amount of GRAPE harvested:")
        assertCurrentLine("[IMPORTANT] Simulation Statistics: Total amount of GRAPE harvested: 1628850 g.")
    }
}

 ...
 */
class FarmParserBasic14 : ExampleSystemTestExtension() {
    override val name = "sowpossible"
    override val description = "sowpossible.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/sowpossible.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: sowpossible.json is invalid.")
    }
}

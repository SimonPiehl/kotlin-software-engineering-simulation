...
/** Test */
class WheatCycle : SystemTestSELab25() {
    override val name = "Wheat Test cycle"
    override val description = "tests sowing of wheat and sowing plan"

    override val farms = "tim/fieldFarming/wheatcyc/farms.json"
    override val scenario = "tim/fieldFarming/wheatcyc/scenario.json"
    override val map = "tim/fieldFarming/wheatcyc/map.json"
    ...
    override suspend fun run() {
        ...
        assertSowingPlan(0)
        assertNextLine("[IMPORTANT] Farm Action: Machine 0 performs SOWING on tile 3 for 5 days.")
        assertSowingPlan(0)
        // Cannot perform sowing on t4: bc too much range, and not on t5 bc no duration
        ...
        assertSowingPlan(1)
        assertNextLine("[IMPORTANT] Farm Action: Machine 0 performs SOWING on tile 7 for 5 days.")
        assertSowingPlan(1)
        assertNextLine("[IMPORTANT] Farm Machine: Machine 0 is finished and returns to the shed at 0.")
        assertNextLine("[IMPORTANT] Farm: Farm 0 finished its actions.")
    }

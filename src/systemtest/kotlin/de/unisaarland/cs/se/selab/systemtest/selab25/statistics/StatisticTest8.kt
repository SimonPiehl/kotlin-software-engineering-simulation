 ...
 */
class StatisticTest8 : ExampleSystemTestExtension() {
    override val name = "StatisticTest8"
    ...
    override suspend fun run() {
        skipUntilString("[IMPORTANT] Simulation Statistics: Total amount of OAT harvested:")
        assertCurrentLine("[IMPORTANT] Simulation Statistics: Total amount of OAT harvested: 145889 g.")
    }
}

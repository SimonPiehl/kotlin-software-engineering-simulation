 ...
 */
class FarmParserBasic11 : ExampleSystemTestExtension() {
    override val name = "sowown"
    override val description = "sowown.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/sowown.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: sowown.json is invalid.")
    }
}

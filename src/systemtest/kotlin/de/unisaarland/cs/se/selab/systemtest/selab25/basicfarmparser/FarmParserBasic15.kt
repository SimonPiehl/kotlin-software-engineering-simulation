 ...
 */
class FarmParserBasic15 : ExampleSystemTestExtension() {
    override val name = "uniquefarmid"
    override val description = "uniquefarmid.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/uniquefarmid.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: uniquefarmid.json is invalid.")
    }
}

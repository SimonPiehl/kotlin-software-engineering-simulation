 ...
 */
class StatisticTest3 : ExampleSystemTestExtension() {
    override val name = "StatisticTest3"
    ...
    override suspend fun run() {
        skipUntilString("[IMPORTANT] Simulation Statistics: Total amount of CHERRY harvested:")
        assertCurrentLine("[IMPORTANT] Simulation Statistics: Total amount of CHERRY harvested: 393660 g.")
    }
}

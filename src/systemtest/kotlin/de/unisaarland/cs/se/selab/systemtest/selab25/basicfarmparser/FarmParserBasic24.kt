 ...
 */
class FarmParserBasic24 : ExampleSystemTestExtension() {
    override val name = "machineonfarmstead should work"
    override val description = "machineonfarmstead.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/t/machineonfarmstead.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[INFO] Initialization Info: machineonfarmstead.json successfully parsed and validated.")
    }
}

 ...
 * @constructor
 */
class FarmHasNonExistingFields : ExampleSystemTestExtension() {
    override val name = "FarmHasNonExistingFields Niklas"
    override val description = "A Farm has elements in the key fields, that don't exist in the map"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "niklas/farmsFarmHasNonExistingFields.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine(
            "[IMPORTANT] Initialization Info: farmsFarmHasNonExistingFields.json is invalid."
        )
    }
}

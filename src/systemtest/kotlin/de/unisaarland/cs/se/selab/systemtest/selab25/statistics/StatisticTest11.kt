 ...
 */
class StatisticTest11 : ExampleSystemTestExtension() {
    override val name = "StatisticTest11"
    ...
    override suspend fun run() {
        skipUntilString("[IMPORTANT] Simulation Statistics: Farm 1 collected")
        assertCurrentLine("[IMPORTANT] Simulation Statistics: Farm 1 collected 4820008 g of harvest.")
    }
}

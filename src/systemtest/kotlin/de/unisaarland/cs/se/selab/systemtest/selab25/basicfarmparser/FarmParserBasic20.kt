 ...
 */
class FarmParserBasic20 : ExampleSystemTestExtension() {
    override val name = "uniquemachineother"
    override val description = "uniquemachineother.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/uniquemachineother.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: uniquemachineother.json is invalid.")
    }
}

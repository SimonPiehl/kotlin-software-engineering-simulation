 ...
 */
class StatisticTest7 : ExampleSystemTestExtension() {
    override val name = "StatisticTest7"
    ...
    override suspend fun run() {
        skipUntilString("[IMPORTANT] Simulation Statistics: Total amount of PUMPKIN harvested:")
        assertCurrentLine("[IMPORTANT] Simulation Statistics: Total amount of PUMPKIN harvested: 174338 g.")
    }
}

 ...
 */
class FarmParserBasic9 : ExampleSystemTestExtension() {
    override val name = "machineonfarmstead"
    override val description = "machineonfarmstead.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/machineonfarmstead.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: machineonfarmstead.json is invalid.")
    }
}

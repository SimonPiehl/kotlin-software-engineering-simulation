 ...
 */
class FarmParserBasic16 : ExampleSystemTestExtension() {
    override val name = "uniquefarmname"
    override val description = "uniquefarmname.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/uniquefarmname.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: uniquefarmname.json is invalid.")
    }
}

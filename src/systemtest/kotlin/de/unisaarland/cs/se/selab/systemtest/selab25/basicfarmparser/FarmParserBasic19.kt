 ...
 */
class FarmParserBasic19 : ExampleSystemTestExtension() {
    override val name = "uniquemachinename"
    override val description = "uniquemachinename.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/uniquemachinename.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: uniquemachinename.json is invalid.")
    }
}

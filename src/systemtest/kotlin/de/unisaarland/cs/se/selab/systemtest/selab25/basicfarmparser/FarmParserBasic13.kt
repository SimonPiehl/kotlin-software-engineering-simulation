 ...
 */
class FarmParserBasic13 : ExampleSystemTestExtension() {
    override val name = "sowown3"
    override val description = "sowown3.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/sowown3.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: sowown3.json is invalid.")
    }
}

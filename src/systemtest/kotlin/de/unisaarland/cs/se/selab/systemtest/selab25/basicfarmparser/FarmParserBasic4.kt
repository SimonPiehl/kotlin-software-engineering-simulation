 ...
 */
class FarmParserBasic4 : ExampleSystemTestExtension() {
    override val name = "hasallfields"
    override val description = "hasallfields.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/hasallfields.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: hasallfields.json is invalid.")
    }
}

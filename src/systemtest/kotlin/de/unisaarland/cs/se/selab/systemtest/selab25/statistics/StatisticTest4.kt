 ...
 */
class StatisticTest4 : ExampleSystemTestExtension() {
    override val name = "StatisticTest4"
    ...
    override suspend fun run() {
        skipUntilString("[IMPORTANT] Simulation Statistics: Total amount of ALMOND harvested:")
        assertCurrentLine("[IMPORTANT] Simulation Statistics: Total amount of ALMOND harvested: 932576 g.")
    }
}

 ...
 */
class StatisticTest2 : ExampleSystemTestExtension() {
    override val name = "StatisticTest2"
    ...
    override suspend fun run() {
        skipUntilString("[IMPORTANT] Simulation Statistics: Total harvest estimate still in fields and plantations:")
        assertCurrentLine(

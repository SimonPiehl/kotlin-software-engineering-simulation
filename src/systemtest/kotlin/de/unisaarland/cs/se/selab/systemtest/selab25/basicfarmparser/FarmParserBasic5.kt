 ...
 */
class FarmParserBasic5 : ExampleSystemTestExtension() {
    override val name = "hasallfields2"
    override val description = "hasallfields2.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/hasallfields2.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: hasallfields2.json is invalid.")
    }
}

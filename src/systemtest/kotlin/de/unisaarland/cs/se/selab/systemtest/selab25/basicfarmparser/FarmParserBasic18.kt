 ...
 */
class FarmParserBasic18 : ExampleSystemTestExtension() {
    override val name = "uniquemachineid"
    override val description = "uniquemachineid.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/uniquemachineid.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: uniquemachineid.json is invalid.")
    }
}

 ...
 */
class BasicPlantTypeAlmondTest2 : ExampleSystemTestExtension() {
    override val name = "BasicPlantTypeAlmondTest2"
    override val description = "Tests if CUTTING almond not performed logged start" +
        " in late february and estimation right"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[INFO] Harvest Estimate: Harvest estimate on tile 1 changed to 400000 g of ALMOND.")
    }
}

 ...
 */
class FarmParserBasic3 : ExampleSystemTestExtension() {
    override val name = "hasaction"
    override val description = "hasaction.json"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "FarmParserSimple/FarmParserjson/hasaction.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: hasaction.json is invalid.")
    }
}

 ...
 *
 */
class CloudSimpleMergeDurationInfOne : SystemTestSELab25() {
    override val name = "CloudSimpleMergeDurationInfOne"
    override val description = "tests duration of merged clouds from two with dur 2 and -1"

    override val farms = "tim/merge/farms.json"
    override val scenario = "tim/merge/scenario2.json"
